    ...
    <div className="relative mx-12 pb-12 grid before:absolute before:left-[-35px] before:block before:h-full before:border-l-2 before:border-black/20 dark:before:border-white/15 before:content-[''] md:grid-cols-5 md:gap-10 md:space-x-4]">
      <div className="relative pb-12 md:col-span-2">
        <div className="sticky top-0">
          ...
          <h4 className="font-semibold text-xl text-gray-600 dark:text-dark-gray">
            {company}
          </h4>
      ...
      <div className="relative flex flex-col gap-2 pb-4 text-gray-600dark:text-dark-gray md:col-span-3">
        {description}
        {link && (
            <a
                href={link}
                className="text-yellow-400 hover:underline dark:text-yellow-400"
            >
                Ver más
            </a>
        )}
